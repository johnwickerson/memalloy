./comparator -desc "standard_ser_equals_behaviours" -arch SQL -violates models/sql16.als -satisfies models/sql16_phen_ser.als -events 8 -expect 0
./comparator -desc "overdefinition_equals_standard" -arch SQL -violates models/sql16_overdefined_serializability.als -satisfies models/sql16.als -events 8 -expect 0
./comparator -desc "standard_equals_overdefinition" -arch SQL -violates models/sql16.als -satisfies models/sql16_overdefined_serializability.als -events 8 -expect 0
