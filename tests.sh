...
./comparator -desc "not_PTSO_2ev" -arch X86 -violates models/x86ptso.cat -events 2 -iter -expect 17
./comparator -desc "not_PTSO_3ev" -arch X86 -violates models/x86ptso.cat -events 3 -iter -expect 39
./comparator -desc "TSO_not_PTSO" -arch X86 -satisfies models/x86tso.cat -violates models/x86ptso.cat -satisfies models/normws.cat -events 4 -iter -expect 6
