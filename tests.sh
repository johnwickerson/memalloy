...
./comparator -desc "C11_not_PC11" -arch C -satisfies models/c11_lahav.cat -violates models/c11_lahav_persistent.cat -satisfies models/c11_normws.cat -events 3 -iter -expect 9
