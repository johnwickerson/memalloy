...
./comparator -desc "ptx_orig_not_cumul_5ev_iter" -arch PTX -fencerels -violates models/ptx_cumul.cat -satisfies models/ptx_orig.cat -satisfies models/normws.cat -satisfies models/ptx_singlegl.cat -iter -events 5 -expect 14
...
./comparator -desc "compile_c11_x86_5ev" -arch C -arch2 X86 -fencerels -violates models/c11_simp.cat -satisfies models/x86tso.cat -mapping mappings/fences_as_relations/c11_x86a.als -events 5 -events2 5 -expect 0 #slow
