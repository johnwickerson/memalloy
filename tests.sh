...
./comparator -arch C -desc "c11_scdrf_bug_2ev" -violates models/sc.cat -satisfies models/c11_nodrf.cat -satisfies models/c11_normws.cat -satisfies models/c11_onlysc.cat -events 4 -expect 1
