...
fun ppo[x : Exec_PPC] : E->E {
  ...
  let ci3 = ci0 + ci1.ii2 + cc1.ci2 |
  let ii3 = ii0 + ci2 + ic2.ci2 + ii2.ii2 |
  let cc3 = cc0 + ci2 + ci2.ic2 + cc2.cc2 |
  let ic3 = ic0 + ii2 + cc2 + ic2.cc2 + ii2.ic2 |

  let ci4 = ci0 + ci1.ii3 + cc1.ci3 |
  let ii4 = ii0 + ci3 + ic3.ci3 + ii3.ii3 |
  let cc4 = cc0 + ci3 + ci3.ic3 + cc3.cc3 |
  let ic4 = ic0 + ii3 + cc3 + ic3.cc3 + ii3.ic3 |

  let ci = ci0 + ci4.ii4 + cc4.ci4 |
  let ii = ii0 + ci4 + ic4.ci4 + ii4.ii4 |
  let cc = cc0 + ci4 + ci4.ic4 + cc4.cc4 |
  let ic = ic0 + ii4 + cc4 + ic4.cc4 + ii4.ic4 |
